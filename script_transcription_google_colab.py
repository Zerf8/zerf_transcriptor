...
# 🏆 Transcriptor ZERF (Edición Definitiva)
**Motor:** OpenAI Whisper Oficial (Modelo `large`)
**Configuración:** Calidad Máxima, Prompt Completo Anti-Alucinaciones
"""
...
print("✅ Entorno preparado. CUDA disponible:", torch.cuda.is_available())
...
# @title 4. EJECUTAR PROCESO DE TRANSCRIPCIÓN
# @markdown Lee `lista_maestra_videos.txt` y procesa los videos.

# VARIABLE PARA LIMITAR EL NÚMERO DE VIDEOS (0 = Todos)
NUM_VIDEOS_LIMIT = 5 # @param {type:"integer"}

# Cargar Modelo (Solo una vez)
if 'model' not in globals():
    print("⏳ Cargando modelo OpenAI Whisper 'large' (puede tardar un poco)...")
    ...
    for i, line_raw in enumerate(videos, 1):
        ...
        try:
            ...
            if not os.path.exists(audio_path):
                ...
                print("   ✅ Audio ya existente.")

            # 3. Transcribir
            print("   🎤 Transcribiendo con OpenAI Whisper Large...")
            # Usamos prompt dinámico
            ...
            # 4. Guardar SRT (Subtítulos)
            write_srt(result['segments'], srt_path)
            print(f"   💾 SRT Guardado: {os.path.basename(srt_path)}")
